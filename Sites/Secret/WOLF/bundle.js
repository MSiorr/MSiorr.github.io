    ...
    Enemy.prototype.changeAction = function (actionName, camera) {
        ...
        switch (actionName) {
            case _Config__WEBPACK_IMPORTED_MODULE_4__.enemyActionTypes.HIT: {
                this.animManager.change(this, _Config__WEBPACK_IMPORTED_MODULE_4__.animNames.ENEMY_HIT, function (aD) { if (aD.animation.index == 0 && aD.animation.fullPlayed) {
            ...
            case _Config__WEBPACK_IMPORTED_MODULE_4__.enemyActionTypes.DEAD: {
                this.animManager.change(this, _Config__WEBPACK_IMPORTED_MODULE_4__.animNames.ENEMY_DEAD, function (animD) { if (animD.animation.index == 0 && animD.animation.fullPlayed) {
